(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      username: ["kingofthebop"],                // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      list: null,                               // [string]   optional name of list belonging to username
      favorites: true,                         // [boolean]  display the user's favorites instead of his tweets
